...
/*
  This is a head file developed by Jun Liu and Jieping Ye and implements 
  the code described in their paper:
  
  Efficient Euclidean Projections in Linear Time, ICML 2009.
